...
-- F-03 (PRF): agrega `passkey.revoked` al catálogo cerrado de
-- `audit_log_entries.event_type` — mismo patrón que cada migración
-- anterior que extendió este catálogo (0014/0017/0020/0021/0022/0024),
-- lista completa recopiada de 0024_export_policy.sql más el valor nuevo.
