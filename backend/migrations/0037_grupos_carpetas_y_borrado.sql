...
-- Hallazgo real de uso 2026-08-11: grupos como unidad de trabajo real —
-- carpetas anidadas por grupo, visibilidad de usuarios acotada por grupo, y
-- borrado de recursos (antes no existía ningún endpoint para esto, ver
-- `resources.deleted_at`, columna desde Fase 0 que nunca se escribía).
-- `DELETE /resources/{id}` nuevo necesita su propio evento de auditoría.
