...
- `Ellkan_<versión>_x64_es-ES.msi`: instalador (sin firmar) generado con `.\build-windows.ps1 -Msi` (WiX 3 vía Tauri; la primera vez descarga WiX, hace falta internet). Se desinstala desde Configuración → Aplicaciones o con «Desinstalar Ellkan» del menú Inicio, y no borra los datos del usuario.
